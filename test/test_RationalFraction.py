...
class TestRationalFraction(unittest.TestCase):
    ...
    def test_power(self):
        self.assertEqual(str(RationalFraction("2") ** RationalFraction(3)), "8/1")
        self.assertEqual(str(RationalFraction("2") ** RationalFraction(-3)), "1/8")
        self.assertEqual(str(RationalFraction("-2") ** RationalFraction(3)), "-8/1")
        self.assertEqual(str(RationalFraction("-2") ** RationalFraction(-3)), "-1/8")
        self.assertEqual(str(RationalFraction("10") ** RationalFraction(0)), "1/1")
